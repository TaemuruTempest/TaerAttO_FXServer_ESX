...
AddEventHandler('taeratto_interaction:server:RequestInteraction', function(target, dead, type)
	...
	TriggerClientEvent('taeratto_interaction:client:RequestReceive', target, dead, type)
end)
...
AddEventHandler('taeratto_interaction:server:AcceptRequest', function(target, type)
	TriggerClientEvent('taeratto_interaction:client:SendAcceptToSource', target, type)
	TriggerClientEvent('taeratto_interaction:client:SendAcceptToTarget', source, target, type)
end)
